...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT(
		...
		LALT_T(KC_TILD),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,                  KC_SCLN, KC_QUOT,             KC_ENT,
		KC_LSFT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,                KC_SLSH, MT(MOD_RSFT, KC_UP), MO(1),
		KC_LCTL,  KC_NO,     KC_LGUI,                           KC_SPC,                              MT(MOD_RGUI, KC_LEFT), KC_NO  , MT(MOD_RCTL, KC_RIGHT)
	),
